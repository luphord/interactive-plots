 ...
 */
function margrabesFormula(S1, S2, T, sigma1, sigma2, rho, q1, q2, scale) {
 ...
 * @returns {PricingResult}
 */
function margrabesFormulaShort(S1, S2, T, sigma, q1, q2, scale) {
 ...
 */
function eqBlackScholes(S, K, T, sigma, q, r, scale) {
    if (typeof scale === 'undefined') {
        scale = 1.0;
    }
    assertNumber(scale);
 ...
 */
function fxBlackScholes(S, K, T, sigma, rFor, rDom, scale) {
 ...
 */
function irBlack76(F, K, T, sigma, r, scale) {
 ...
 */
function irBlack76BondOption(bond, K, T, sigma, spotCurve) {
 ...
 */
function irBlack76CapletFloorlet(floatingRate, K, sigma, spotCurve) {
 ...
 */
function irForwardPrice(cashflows, discountCurve, t) {
 ...
 */
function irRollFromEnd(start, end, frequency) {
 ...
 */
function irFlatDiscountCurve(flatRate) {
 ...
 * @returns {SpotCurve}
 */
function irLinearInterpolationSpotCurve(spotRates) {
 ...
 * @returns {DiscountCurve}
 */
function irSpotCurve2DiscountCurve(spotCurve) {
 ...
 * @returns {SpotCurve}
 */
function irDiscountCurve2SpotCurve(discountCurve) {
 ...
 */
function irInternalRateOfReturn(cashflows, r0=0, r1=0.05, abstol=1e-8, maxiter=100) {
